...
rm -f /e/learnflow/artifacts/_fresh.db
DATABASE_URL="sqlite+aiosqlite:///E:/learnflow/artifacts/_fresh.db" DEMO_DATA_ENABLED=true $PY -m uvicorn app.main:app --host 127.0.0.1 --port 8000 \
...
node verify_lai_card.mjs 2>&1 | tail -30

kill $BE $FE 2>/dev/null
rm -f /e/learnflow/artifacts/_be.log /e/learnflow/artifacts/_fe.log /e/learnflow/artifacts/_fresh.db
echo "CLEANUP_DONE"
