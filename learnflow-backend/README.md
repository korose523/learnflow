...
│   │   │   ├── memory_science_engine.py # 记忆科学引擎（FSRS、记忆术、巩固建议）
│   │   │   ├── habit_addiction_engine.py # 习惯化成瘾引擎（习惯叠加、执行意图）
...
### 6. 记忆科学引擎
基于学习科学证据的 FSRS 间隔重复、记忆术、具体例子、睡眠/运动巩固建议，以及适难性学习方法推荐。

### 7. 习惯化与自我调节
基于习惯叠加、诱惑捆绑、执行意图和自我调节学习理论，帮助学生建立可持续、健康、自主的学习习惯。
