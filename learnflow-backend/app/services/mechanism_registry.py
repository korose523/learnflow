...
_SPECS_DATA: List[Dict[str, Any]] = [
    ...
    {"id": "LF-M01", "key": "variable_ratio_reward", "name_zh": "变比率奖励（宝箱）",
     ...
     "impl_ref": "gamification_service.py:GamificationService", "disposition": "K", "maturity": "complete"},
    ...
    {"id": "LF-M06", "key": "time_based_bonus", "name_zh": "时间限定加成",
     ...
     "theory_ref": "强化程序（变动时距）", "impl_ref": "duolingo_addiction_engine.py:TimeBasedBonusEngine",
    ...
    {"id": "LF-M07", "key": "collection", "name_zh": "集换收藏",
     ...
     "theory_ref": "Zeigarnik 变体；完成欲", "impl_ref": "deep_addiction_engine.py:CollectionEngine",
     "disposition": "R", "maturity": "partial"},
    ...
    {"id": "LF-M11", "key": "streak", "name_zh": "连胜", "name_en": "Streak",
     ...
     "impl_ref": "duolingo_addiction_engine.py:DuolingoStreakEngine", "disposition": "M", "maturity": "complete",
    ...
    {"id": "LF-M15", "key": "goal_gradient", "name_zh": "目标梯度/近距目标",
     ...
     "theory_ref": "Hull 1934; Locke & Latham 1990",
     # 指向真正的目标梯度计算（渐近目标进度 + 80% 脉冲），而非仅数据模型 ProximalGoals
     "impl_ref": "gamification_service.py:GamificationService.get_goal_progress",
     "disposition": "R", "maturity": "partial"},
    {"id": "LF-M16", "key": "daily_challenge", "name_zh": "每日/月度挑战",
     "name_en": "Daily & Monthly Challenge", "stage": "pre", "category": "retention",
     "theory_ref": "Locke & Latham 1990", "impl_ref": "duolingo_addiction_engine.py:MonthlyChallengeEngine",
     "disposition": "K", "maturity": "complete"},
    ...
    {"id": "LF-M19", "key": "xp_leveling", "name_zh": "经验值与等级",
     ...
     "theory_ref": "二级强化；SDT 胜任感", "impl_ref": "duolingo_addiction_engine.py:XPEngine",
    ...
    {"id": "LF-M27", "key": "leaderboard", "name_zh": "排行榜与联赛",
     ...
     "theory_ref": "Garcia & Tor 2009 (N-effect)", "impl_ref": "duolingo_addiction_engine.py:LeagueEngine",
    ...
    {"id": "LF-M30", "key": "friend_quest", "name_zh": "组队任务", "name_en": "Friend Quest",
     ...
     "impl_ref": "duolingo_addiction_engine.py:FriendQuestEngine", "disposition": "R", "maturity": "partial",
     "notes": "落库"},
    ...
    {"id": "LF-M39", "key": "self_regulation_goals", "name_zh": "自我调节目标",
     ...
     "theory_ref": "Zimmerman 2002; Bandura 1991", "impl_ref": "habit_addiction_engine.py:SelfRegulationEngine",
     "disposition": "R", "maturity": "partial", "notes": "落库"},
